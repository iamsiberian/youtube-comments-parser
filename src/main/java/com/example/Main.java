 ...
 *
 */
public class Main { //CommentHandling videoId: https://www.youtube.com/watch?v=MMr-TPDfc60
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            youtube = new YouTube
                    ...
                    .setApplicationName("youtube-cmdline-commentthreads-sample")
                    .build();
            ...
            if (videoComments.isEmpty()) {
                ...
                Comment commentInsertResponse = youtube
                        .comments()
                ...
                // existing comment
                // replies.
                CommentListResponse commentsListResponse = youtube
                        .comments()
                        .list("snippet")
                ...
                if (comments.isEmpty()) {
                    ...
                    Comment commentUpdateResponse = youtube
                            .comments()
                            .update("snippet", firstCommentReply)
                            .execute();
                    ...
                    System.out.println(
                            "  -  Changed comment status to published: " + firstCommentReply.getId()
                    );
            ...
            System.err.println(
                    "GoogleJsonResponseException code: " + e.getDetails().getCode() + " : " + e.getDetails().getMessage()
            );
            e.printStackTrace();
...
/*
    void readAllComments(String videoId) {
        try {
